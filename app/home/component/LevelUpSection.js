            ...
            <div className="bg-[url(/image/landing/background.png)] bg-no-repeat bg-center bg-cover w-full 2xl:py-[44px] py-[18px] rounded-[20px]">
              <div className="sm:-mx-[50px] -mx-[30px]">
                <div className={classNames(
                  ...
                  <h3 data-aos="zoom-in-up" className="uppercase text-[#6F2268] text-[10px] sm:text-[8px] xl:text-[14px]">LET’S GET STARTED</h3>
                  <h2 data-aos="zoom-in-up" data-aos-delay="200" className="font-semibold text-[20px] xl:text-[40px] xl:leading-[56px] font-inter">Level-up your data quality 🚀</h2>
                  <p data-aos="zoom-in-up" data-aos-delay="200" className="text-center text-[#979797] text-[12px] sm:text-[10px] xl:text-[20px]  ">Create Smart, Secure, Collaborative forms and start revealing deeper insights </p>
                  <button data-aos="zoom-in-up" data-aos-delay="300" className={classNames(
                    ...
                    <span className="font-medium text-[14px] text-white sm:text-[10px] sm:leading-[9px] xl:text-[20px] xl:leading-[18px]">Create your First Form</span>
                    <Image 
